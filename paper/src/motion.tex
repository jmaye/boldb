Our motion segmentation algorithm is based on \emph{change-point
...
%Knowing this distribution for
%all $t$, we show below how the positions of the change points can be
%inferred.

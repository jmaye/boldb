...
Fig.~\ref{fig:transition} shows an example of transitions from $r_{t-1}$ to
$r_{t+1}$.
...
\node (a) at (-2, 2) {$r_{t-1}=0$};
\node (b) at (-2, 0) {$r_{t-1}=1$};
\node (c) at (-2, -2) {$r_{t-1}=2$};
\node (d) at (0, 2) {$r_t=0$};
\node (e) at (0, 0) {$r_t=1$};
\node (f) at (0, -2) {$r_t=2$};
\node (g) at (2, 2) {$r_{t+1}=0$};
\node (h) at (2, 0) {$r_{t+1}=1$};
\node (i) at (2, -2) {$r_{t+1}=2$};
\draw [->,thick] (a) -- (d);
\draw [->,thick] (a) -- (e);
\draw [->,thick] (b) -- (d);
\draw [->,thick] (b) -- (f);
